...
CATALOGO = [
    {
        ...
        "link": f"https://www.amazon.com.br/s?k=batedeira+planetaria&tag={AMAZON_TAG}",
    },
    {
        "nome": "Ração para Cães Adultos 15kg",
        "categoria": "petshop pet cao cachorro ração",
        "link": f"https://www.amazon.com.br/s?k=racao+caes+adultos+15kg&tag={AMAZON_TAG}",
    },
    {
        "nome": "Smartphone Samsung Galaxy",
        "categoria": "celular tecnologia eletronicos",
        "link": f"https://www.amazon.com.br/s?k=smartphone+samsung+galaxy&tag={AMAZON_TAG}",
    },
    {
        "nome": "Fone de Ouvido Bluetooth Sem Fio",
        "categoria": "fone audio musica eletronicos",
        "link": f"https://www.amazon.com.br/s?k=fone+de+ouvido+bluetooth&tag={AMAZON_TAG}",
    },
    {
        "nome": "Parafusadeira e Furadeira a Bateria",
        "categoria": "ferramentas furadeira parafusadeira",
        "link": f"https://www.amazon.com.br/s?k=parafusadeira+furadeira+bateria&tag={AMAZON_TAG}",
    },
]
